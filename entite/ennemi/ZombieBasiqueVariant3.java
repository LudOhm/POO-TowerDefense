...
public class ZombieBasiqueVariant3 extends Ennemi{
    public ZombieBasiqueVariant3(double x, double y){
        this.setImg(Toolkit.getDefaultToolkit().getImage("ressource/enemy/zombieBasiqueVariant3/zombieBasiqueVariant3.png"),0);
        this.setX(x);
        this.setY(y);
        ...
        this.setNom("Zombie basique variant 3");
