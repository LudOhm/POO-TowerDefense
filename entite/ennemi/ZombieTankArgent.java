...
public class ZombieTankArgent extends Ennemi {

    public ZombieTankArgent(double x, double y){
        this.setImg(Toolkit.getDefaultToolkit().getImage("ressource/enemy/zombieTankArgent/zombieTankArgent.png"),0);
        this.setX(x);
        this.setY(y);
        ...
        this.setNom("Zombie tank argent");
